 ...
 */
final class Version20200313165650 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, shop_id INT NOT NULL, text LONGTEXT NOT NULL, file LONGTEXT DEFAULT NULL, author VARCHAR(255) NOT NULL, INDEX IDX_794381C64D16C4DD (shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
